...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template mode="BG-4" match="/Invoice:Invoice/cac:AccountingSupplierParty">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:AccountingSupplierParty der Instanz in konkreter Syntax wird auf
   ...
   <xsl:template mode="BG-5"
      ...
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress der Instanz
   ...
   <xsl:template mode="BG-7" match="/Invoice:Invoice/cac:AccountingCustomerParty">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:AccountingCustomerParty der Instanz in konkreter Syntax wird auf
         8 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-8"
      ...
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress der Instanz
         in konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-10" match="/Invoice:Invoice/cac:PayeeParty">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:PayeeParty der Instanz in konkreter Syntax wird auf 3 Objekte der
         EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-11" match="/Invoice:Invoice/cac:TaxRepresentativeParty">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:TaxRepresentativeParty der Instanz in konkreter Syntax wird auf 3
   ...
   <xsl:template mode="BG-12" match="/Invoice:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:TaxRepresentativeParty/cac:PostalAddress der Instanz in konkreter
         Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-13" match="/Invoice:Invoice/cac:Delivery">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:Delivery der Instanz in konkreter Syntax wird auf 5 Objekte der
         EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-14" match="/Invoice:Invoice/cac:InvoicePeriod">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:InvoicePeriod der Instanz in konkreter Syntax wird auf 2 Objekte
   ...
   <xsl:template mode="BG-17" match="/Invoice:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:PaymentMeans/cac:PayeeFinancialAccount der Instanz in konkreter
   ...
   <xsl:template mode="BG-18" match="/Invoice:Invoice/cac:PaymentMeans/cac:CardAccount">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:PaymentMeans/cac:CardAccount der Instanz in konkreter Syntax wird
   ...
   <xsl:template mode="BG-19" match="/Invoice:Invoice/cac:PaymentMeans/cac:PaymentMandate">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:PaymentMeans/cac:PaymentMandate der Instanz in konkreter Syntax
         wird auf 3 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-23" match="/Invoice:Invoice/cac:TaxTotal/cac:TaxSubtotal">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:TaxTotal/cac:TaxSubtotal der Instanz in konkreter Syntax wird auf
         6 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-24" match="/Invoice:Invoice/cac:AdditionalDocumentReference">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:AdditionalDocumentReference der Instanz in konkreter Syntax wird
         auf 4 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-25" match="/Invoice:Invoice/cac:InvoiceLine">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad /Invoice:Invoice/cac:InvoiceLine der Instanz in konkreter Syntax wird auf 15 Objekte
         der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-28" match="cac:AllowanceCharge[cbc:ChargeIndicator = 'true']">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:AllowanceCharge[cbc:ChargeIndicator = 'true'] der Instanz in konkreter Syntax wird
         auf 5 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-29" match="cac:Price">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:Price der Instanz in konkreter Syntax wird auf 5 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-30" match="cac:Item/cac:ClassifiedTaxCategory">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:Item/cac:ClassifiedTaxCategory der Instanz in konkreter Syntax wird auf 2 Objekte
         der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-31" match="cac:Item">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:Item der Instanz in konkreter Syntax wird auf 8 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-32" match="cac:Item/cac:AdditionalItemProperty">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:Item/cac:AdditionalItemProperty der Instanz in konkreter Syntax wird auf 2 Objekte
         der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-DEX-02" match="cac:SubInvoiceLine/cac:Item">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:SubInvoiceLine/cac:Item der Instanz in konkreter Syntax wird auf 8 Objekte der EN
         16931 abgebildet. -->
         <xsl:apply-templates mode="BT-153"
   ...
   <xsl:template mode="BG-DEX-08" match="cac:SubInvoiceLine/cac:Item/cac:AdditionalItemProperty">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:SubInvoiceLine/cac:Item/cac:AdditionalItemProperty der Instanz in konkreter Syntax
   ...
   <xsl:template mode="BG-DEX-03"
      ...
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:SubInvoiceLine/cac:AllowanceCharge[cbc:ChargeIndicator = 'false'] der Instanz in
   ...
   <xsl:template mode="BG-DEX-06" match="cac:SubInvoiceLine/cac:ClassifiedTaxCategory">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:SubInvoiceLine/cac:ClassifiedTaxCategory der Instanz in konkreter Syntax wird auf
         2 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-151"
   ...
   <xsl:template mode="BG-DEX-07" match="cac:SubInvoiceLine/cac:Price">
      <xsl:variable name="bg-contents" as="item()*">
         <!--Der
         Pfad cac:SubInvoiceLine/cac:Price der Instanz in konkreter Syntax wird auf 5 Objekte der EN
         16931 abgebildet. -->
         <xsl:apply-templates mode="BT-146"
         ...
         <xsl:apply-templates mode="BT-150"
            select="cac:Price/cbc:BaseQuantity/@unitCode" />
      </xsl:variable>
      <xsl:if
         test="$bg-contents">
   ...
   <xsl:template mode="BG-DEX-09" match="cac:PrepaidPayment">
      <xsl:variable name="bg-contents" as="item()*">
         ...
         <xsl:apply-templates
            mode="BT-DEX-002" select="cbc:PaidAmount" />
         <xsl:apply-templates mode="BT-DEX-003"
