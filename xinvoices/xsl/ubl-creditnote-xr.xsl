...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xd:doc scope="stylesheet">
      <xd:desc>
         ...
         <xd:p>Überführt eine zur EN 16931 konforme elektronische Rechnung in der konkreten Syntax
            UBL.2_1.CreditNote in eine Instanz gemäß des Schemas für den Namensraum
   ...
   <xsl:template match="/CreditNote:CreditNote">
      <xr:invoice>
         ...
         <xsl:for-each-group select="cac:PaymentMeans" group-by="cbc:PaymentMeansCode">
            <xr:PAYMENT_INSTRUCTIONS>
               ...
               <xsl:apply-templates mode="BT-82"
                  select="current-group()[1]/cbc:PaymentMeansCode/@name" />
         ...
         <xsl:apply-templates mode="BG-24"
            select="./cac:AdditionalDocumentReference[not(cbc:DocumentTypeCode = 50)]" />
   ...
   <xsl:template mode="BG-3"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:BillingReference/cac:InvoiceDocumentReference der Instanz
         in konkreter Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-4" match="/CreditNote:CreditNote/cac:AccountingSupplierParty">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AccountingSupplierParty der Instanz in konkreter Syntax
         wird auf 10 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates
            mode="BT-29"
            select="./cac:Party/cac:PartyIdentification/cbc:ID[not(@schemeID = 'SEPA')]" />
         <xsl:apply-templates
   ...
   <xsl:template mode="BG-5"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:PostalAddress der
         ...
         <xsl:apply-templates
            mode="BT-39" select="./cbc:CountrySubentity" />
   ...
   <xsl:template mode="BG-6"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AccountingSupplierParty/cac:Party/cac:Contact der Instanz
         in konkreter Syntax wird auf 3 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-7" match="/CreditNote:CreditNote/cac:AccountingCustomerParty">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AccountingCustomerParty der Instanz in konkreter Syntax
         wird auf 8 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-8"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:PostalAddress der
         Instanz in konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates
            mode="BT-54" select="./cbc:CountrySubentity" />
   ...
   <xsl:template mode="BG-9"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AccountingCustomerParty/cac:Party/cac:Contact der Instanz
         in konkreter Syntax wird auf 3 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-10" match="/CreditNote:CreditNote/cac:PayeeParty">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:PayeeParty der Instanz in konkreter Syntax wird auf 3
         Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-59"
            select="./cac:PartyName/cbc:Name" />
         <xsl:apply-templates mode="BT-60"
            select="./cac:PartyIdentification/cbc:ID[not(@schemeID = 'SEPA')]" />
         <xsl:apply-templates
            mode="BT-61" select="./cac:PartyLegalEntity/cbc:CompanyID" />
      </xsl:variable>
      <xsl:if
         test="$bg-contents">
         <xr:PAYEE>
   ...
   <xsl:template mode="BG-11" match="/CreditNote:CreditNote/cac:TaxRepresentativeParty">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:TaxRepresentativeParty der Instanz in konkreter Syntax wird
   ...
   <xsl:template mode="BG-12"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:TaxRepresentativeParty/cac:PostalAddress der Instanz in
         ...
         <xsl:apply-templates
            mode="BT-68" select="./cbc:CountrySubentity" />
   ...
   <xsl:template mode="BG-13" match="/CreditNote:CreditNote/cac:Delivery">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:Delivery der Instanz in konkreter Syntax wird auf 5 Objekte
         ...
         <xsl:apply-templates mode="BT-71"
            select="./cac:DeliveryLocation/cbc:ID" />
         <xsl:apply-templates mode="BT-72"
            select="./cbc:ActualDeliveryDate" />
         <!--<xsl:apply-templates
         mode="BG-14" select="/CreditNote:CreditNote/cac:InvoicePeriod"/>-->
   ...
   <xsl:template mode="BG-14" match="/CreditNote:CreditNote/cac:InvoicePeriod">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:InvoicePeriod der Instanz in konkreter Syntax wird auf 2
         Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-15"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:Delivery/cac:DeliveryLocation/cac:Address der Instanz in
         konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates
            mode="BT-79" select="./cbc:CountrySubentity" />
   ...
   <xsl:template mode="BG-17"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:PaymentMeans/cac:PayeeFinancialAccount der Instanz in
   ...
   <xsl:template mode="BG-18"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:PaymentMeans/cac:CardAccount der Instanz in konkreter
   ...
   <xsl:template mode="BG-19"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:PaymentMeans/cac:PaymentMandate der Instanz in konkreter
   ...
   <xsl:template mode="BG-20"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator = 'false'] der Instanz
         in konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-21"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AllowanceCharge[cbc:ChargeIndicator = 'true'] der Instanz
         in konkreter Syntax wird auf 7 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-22" match="/CreditNote:CreditNote/cac:LegalMonetaryTotal">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:LegalMonetaryTotal der Instanz in konkreter Syntax wird auf
         10 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-23"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:TaxTotal/cac:TaxSubtotal der Instanz in konkreter Syntax
         wird auf 6 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-24"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:AdditionalDocumentReference der Instanz in konkreter Syntax
   ...
   <xsl:template mode="BG-25" match="/CreditNote:CreditNote/cac:CreditNoteLine">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine der Instanz in konkreter Syntax wird auf 15
         Objekte der EN 16931 abgebildet. -->
         ...
         <xsl:apply-templates
            mode="BT-129" select="./cbc:CreditedQuantity" />
         <xsl:apply-templates mode="BT-130"
            select="./cbc:CreditedQuantity/@unitCode" />
   ...
   <xsl:template mode="BG-26"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:InvoicePeriod der Instanz in konkreter
         Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-27"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator =
         'false'] der Instanz in konkreter Syntax wird auf 5 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-28"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator =
         'true'] der Instanz in konkreter Syntax wird auf 5 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-29"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:Price der Instanz in konkreter Syntax
   ...
   <xsl:template mode="BG-30"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:Item/cac:ClassifiedTaxCategory der
         Instanz in konkreter Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-151"
            select="./cbc:ID[following-sibling::cac:TaxScheme/cbc:ID = 'VAT']" />
         <xsl:apply-templates
            mode="BT-152" select="./cbc:Percent" />
      </xsl:variable>
      <xsl:if test="$bg-contents">
   ...
   <xsl:template mode="BG-31" match="/CreditNote:CreditNote/cac:CreditNoteLine/cac:Item">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:Item der Instanz in konkreter Syntax
         wird auf 8 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-32"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /CreditNote:CreditNote/cac:CreditNoteLine/cac:Item/cac:AdditionalItemProperty der
         Instanz in konkreter Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
   ...
   <xsl:template mode="BG-DEX-01" match="cac:SubCreditNoteLine">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine der Instanz in konkreter Syntax wird auf 14 Objekte der EN 16931
         abgebildet. -->
         <xsl:apply-templates mode="BT-126"
            select="/CreditNote:CreditNote/cac:CreditNoteLine/cbc:ID" />
         <xsl:apply-templates
            mode="BT-127"
         ...
         <xsl:apply-templates
            mode="BG-DEX-02" select="./cac:Item" />
         ...
         <xsl:apply-templates
            ...
            select="./cac:AllowanceCharge[cbc:ChargeIndicator = 'true']" />
         <xsl:apply-templates
            mode="BG-DEX-05" select="./cac:InvoicePeriod" />
         <xsl:apply-templates mode="BG-DEX-06"
            select="./cac:ClassifiedTaxCategory" />
         <xsl:apply-templates mode="BG-DEX-07"
            select="./cac:Price" />
      </xsl:variable>
      <xsl:if test="$bg-contents">
         <xr:SUB_INVOICE_LINE>
   ...
   <xsl:template mode="BG-DEX-02" match="cac:SubCreditNoteLine/cac:Item">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:Item der Instanz in konkreter Syntax wird auf 8 Objekte der
         EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-153"
         ...
         <xsl:apply-templates
            mode="BG-DEX-08" select="./cac:AdditionalItemProperty" />
      </xsl:variable>
      <xsl:if
         test="$bg-contents">
   ...
   <xsl:template mode="BG-DEX-08"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:Item/cac:AdditionalItemProperty der Instanz in konkreter
         Syntax wird auf 2 Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-160"
   ...
   <xsl:template mode="BG-DEX-03"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = 'false'] der Instanz
   ...
   <xsl:template mode="BG-DEX-04"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = 'true'] der Instanz in
   ...
   <xsl:template mode="BG-DEX-05" match="cac:SubCreditNoteLine/cac:InvoicePeriod">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:InvoicePeriod der Instanz in konkreter Syntax wird auf 2
         Objekte der EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-134"
   ...
   <xsl:template mode="BG-DEX-06"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:ClassifiedTaxCategory der Instanz in konkreter Syntax wird
   ...
   <xsl:template mode="BG-DEX-07" match="cac:SubCreditNoteLine/cac:Price">
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad cac:SubCreditNoteLine/cac:Price der Instanz in konkreter Syntax wird auf 5 Objekte der
         EN 16931 abgebildet. -->
         <xsl:apply-templates mode="BT-146"
