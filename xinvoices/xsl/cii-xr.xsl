...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xd:doc scope="stylesheet">
      <xd:desc>
         ...
         <xd:p>Überführt eine zur EN 16931 konforme elektronische Rechnung in der konkreten Syntax
            UNCEFACT.CII.D16B in eine Instanz gemäß des Schemas für den Namensraum
   ...
   <xsl:template mode="BG-2"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         Pfad /rsm:CrossIndustryInvoice/rsm:ExchangedDocumentContext der Instanz in konkreter Syntax
   ...
   <xsl:template mode="BG-5"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
            mode="BT-39" select="./ram:CountrySubDivisionName" />
   ...
   <xsl:template mode="BG-8"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
            mode="BT-54" select="./ram:CountrySubDivisionName" />
   ...
   <xsl:template mode="BG-12"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
            mode="BT-68" select="./ram:CountrySubDivisionName" />
   ...
   <xsl:template mode="BG-15"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
            mode="BT-79" select="./ram:CountrySubDivisionName" />
   ...
   <xsl:template mode="BG-17"
      ...
      <xsl:variable name="bg-contents" as="item()*"><!--Der
         ...
         <xsl:apply-templates
            mode="BT-85" select="./ram:AccountName" />
